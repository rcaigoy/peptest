...
function peptidology_scripts() {
	...
	// AJAX Cart - Optimized add to cart without page reload
	if (is_shop() || is_product_category() || is_product_tag()) {
		wp_enqueue_style( 'peptidology-ajax-cart', get_template_directory_uri() . '/css/ajax-cart.css?v=' . time(), array(), _S_VERSION );
		wp_enqueue_script( 'peptidology-ajax-cart', get_template_directory_uri() . '/js/ajax-cart.js?v=' . time(), array('jquery'), _S_VERSION, true );
	}
