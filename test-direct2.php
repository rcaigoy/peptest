<?php
/**
 * Direct Theme Performance Test - Peptidology 2
 * 
 * This loads the page directly (no HTTP requests) to get accurate query counts.
 * Tests the peptidology2 theme by loading WordPress with the theme.
 */

error_reporting(E_ALL);
ini_set('display_errors', 1);

// Force peptidology2 theme for this test
define('TEST_THEME', 'peptidology2');
...
<head>
    ...
    <title>Direct Performance Test - Peptidology 2 Theme</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>📊 Direct Performance Test - Peptidology 2</h1>
            <p>Testing peptidology2 theme (accurate query counting without HTTP requests)</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="alert alert-info">
                ...
                This test specifically loads the <strong>Peptidology 2</strong> theme, regardless of which theme is currently active.<br>
