<?php
/**
 * Direct Theme Performance Test - Peptidology 3
 * 
 * This loads the page directly (no HTTP requests) to get accurate query counts.
 * Tests the peptidology3 theme by loading WordPress with the theme.
 */

error_reporting(E_ALL);
ini_set('display_errors', 1);

// Force peptidology3 theme for this test
define('TEST_THEME', 'peptidology3');
...
<head>
    ...
    <title>Direct Performance Test - Peptidology 3 Theme</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>📊 Direct Performance Test - Peptidology 3</h1>
            <p>Testing peptidology3 theme (accurate query counting without HTTP requests)</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="alert alert-info">
                ...
                This test specifically loads the <strong>Peptidology 3</strong> theme, regardless of which theme is currently active.<br>
